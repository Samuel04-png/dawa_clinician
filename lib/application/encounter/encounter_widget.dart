...
class EncounterWidget extends StatefulWidget {
  ...
  static String routeName = 'Encounter';
  static String routePath = '/encounter';
...
class _EncounterWidgetState extends State<EncounterWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EncounterModel());

    _model.estimatedbabysizeTextController ??= TextEditingController();
    _model.estimatedbabysizeFocusNode ??= FocusNode();

    _model.hemocheckTextController1 ??= TextEditingController();
    _model.hemocheckFocusNode1 ??= FocusNode();

    _model.heartbeatTextController ??= TextEditingController();
    _model.heartbeatFocusNode ??= FocusNode();

    _model.bpTextController ??= TextEditingController();
    _model.bpFocusNode ??= FocusNode();

    _model.pulseTextController ??= TextEditingController();
    _model.pulseFocusNode ??= FocusNode();

    _model.hemocheckTextController2 ??= TextEditingController();
    _model.hemocheckFocusNode2 ??= FocusNode();
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<MotherRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final encounterMotherRecord = snapshot.data!;
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if ((encounterMotherRecord.firstEncounterId ==
                                      null) &&
                                    ...
                                    children: [
                                                ...
                                                child: TextFormField(
                                                  ...
                                                  keyboardType:
                                                      const TextInputType
                                                          ...
                                                          decimal: true),
                                                  validator: _model
                                                      .hemocheckTextController1Validator
                                                      .asValidator(context),
                                                  inputFormatters: [
                                                    if (!isAndroid && !isiOS)
                                                      TextInputFormatter
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              ...
                                              Container(
                                                ...
                                                child: TextFormField(
                                                  controller:
                                                      _model.bpTextController,
                                                  focusNode: _model.bpFocusNode,
                                                  autofocus: false,
                                                  textCapitalization:
                                                      TextCapitalization.none,
                                                  obscureText: false,
                                                ...
                                                child: TextFormField(
                                                  ...
                                                  keyboardType:
                                                      const TextInputType
                                                          ...
                                                          decimal: true),
                                                  validator: _model
                                                      .hemocheckTextController2Validator
                                                      .asValidator(context),
                                                  inputFormatters: [
                                                    if (!isAndroid && !isiOS)
                                                      TextInputFormatter
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          FFButtonWidget(
                                            onPressed: () async {
                                              var encounterRecordReference =
                                                  EncounterRecord.collection
                                                      .doc();
                                              await encounterRecordReference
                                                  .set(
                                                ...
                                                nitrates: _model.nitratesValue,
                                                urologobulin:
                                                    _model.urologobulinValue,
                                                protein: _model.proteinValue,
                                                ph: _model.phValue,
                                                blood: _model.bloodValue,
                                                ketones: _model.ketonesValue,
                                                bilirubin: _model.bilrubinValue,
                                                glucose: _model.glucoseValue,
                                                color: _model.colorValue,
                                                clarity: _model.clarityValue,
                                                ...
                                                heartBeatQuality: _model
                                                    .heartbeatqualityValue,
                                                wombPosition: _model.wombValue,
                                                estimatedBabySize: int.tryParse(
                                                    _model
                                                        .estimatedbabysizeTextController
                                                        .text),
                                                specificGravity:
                                                    _model.gravityValue,
                                                foetalHemocheck: int.tryParse(
                                                    _model
                                                        .hemocheckTextController1
                                                        .text),
                                              ...
                                              _model.createdEncounter =
                                                  EncounterRecord.getDocumentFromData(
                                                      createEncounterRecordData(
                                                        bp: _model
                                                            .bpTextController
                                                            .text,
                                                        ...
                                                        motherId:
                                                            widget.momDetails,
                                                        referForAnemia: _model
                                                            .referAnemiaValue,
                                                        heartBeat: int.tryParse(
                                                            _model
                                                                .heartbeatTextController
                                                                .text),
                                                        heartBeatQuality: _model
